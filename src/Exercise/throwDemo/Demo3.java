...
/*
    ...
    注意：
        ...
        2. 如果try中产生了异常，那么就会执行catch中的异常逻辑，执行完毕catch中的处理逻辑，继续执行try...catch之后的代码
...
public class Demo3{
    public static void main(String[] args) throws Exception{
        try{
            ...
            /*
                ...
                void printStackTrace()：JVM打印异常对象，默认此方法，打印异常对象信息是最全面的
             */
    ...
    /*
        如果传递的路径，不是.txt结尾
        那么我们就抛出IO异常对象，告知方法的调用者，文件名后缀名不对
    */
